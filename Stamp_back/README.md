...
To update the database use this command from the Web project folder (replace `Stamp` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../Stamp.Infrastructure/Stamp.Infrastructure.csproj -s Stamp.Web.csproj
```
